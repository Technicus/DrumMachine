...
(*.[0-9]*)
	...
	if test ! -f /root/Bela/projects/ncurses/ncurses-6.1-20180428/man_alias.sed ; then
cat >>/root/Bela/projects/ncurses/ncurses-6.1-20180428/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /root/Bela/projects/ncurses/ncurses-6.1-20180428/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /root/Bela/projects/ncurses/ncurses-6.1-20180428/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	cf_target=`grep "^$cf_source" /root/Bela/projects/ncurses/ncurses-6.1-20180428/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /root/Bela/projects/ncurses/ncurses-6.1-20180428/man_alias.sed \
		< $i | sed -f /root/Bela/projects/ncurses/ncurses-6.1-20180428/edit_man.sed >$TMP
